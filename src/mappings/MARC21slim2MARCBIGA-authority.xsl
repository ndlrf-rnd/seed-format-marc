...
<xsl:variable name="phys" select="marc:controlField"/>
			...
			<xsl:if test="datafield[200&lt;=@tag and @tag&lt;300]">
				<mrca-complex-see-refs>
					<xsl:apply-templates select="datafield[200&lt;=@tag and @tag&lt;300]"/>
				</mrca-complex-see-refs>
			</xsl:if>
			...
			<xsl:if test="datafield[640&lt;=@tag and @tag&lt;650]">
				<mrca-series-treatment>
					<xsl:apply-templates select="datafield[640&lt;=@tag and @tag&lt;650]"/>
				</mrca-series-treatment>
			</xsl:if>
			<xsl:if test="datafield[663&lt;=@tag and @tag&lt;666]">
				<mrca-refs-notes>
					<xsl:apply-templates select="datafield[663&lt;=@tag and @tag&lt;666]"/>
				</mrca-refs-notes>
			</xsl:if>
			<xsl:if test="datafield[667&lt;=@tag and @tag&lt;700]">
				<mrca-other-notes>
					<xsl:apply-templates select="datafield[667&lt;=@tag and @tag&lt;700]"/>
				</mrca-other-notes>
			</xsl:if>
			<xsl:if test="datafield[700&lt;=@tag and @tag&lt;760]">
				<mrca-est-head-link-entries>
					<xsl:apply-templates select="datafield[700&lt;=@tag and @tag&lt;761]"/>
				</mrca-est-head-link-entries>
			</xsl:if>
			<xsl:if test="datafield[761&lt;=@tag and @tag&lt;768]">
				<mrca-number-building-fields>
					<xsl:apply-templates select="datafield[761&lt;=@tag and @tag&lt;768]"/>
				</mrca-number-building-fields>
			</xsl:if>
			<xsl:if test="datafield[780&lt;=@tag and @tag&lt;=788]">
				<mrca-subdiv-head-link-entries>
					<xsl:apply-templates select="datafield[780&lt;=@tag and @tag&lt;=788]"/>
				</mrca-subdiv-head-link-entries>
			</xsl:if>
			<xsl:if test="datafield[856&lt;=@tag and @tag&lt;856]">
				<mrca-location>
					<xsl:apply-templates select="datafield[856&lt;=@tag and @tag&lt;856]"/>
				</mrca-location>
			</xsl:if>
			<xsl:if test="datafield[880&lt;=@tag and @tag&lt;=880]">
				<mrca-linkage>
