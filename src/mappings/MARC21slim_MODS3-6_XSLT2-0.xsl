<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3"
	...
	<!-- 
		...
		Two prameters
		$datafield: datafield node to use for processing
	...
	<xsl:template match="marc:record">
		...
		<mods version="3.6">
			...
			<xsl:apply-templates
				...
				mode="titleInfo"/>
			<!-- titleInfo type="translated" -->
			<xsl:apply-templates select="datafield[@tag='242']" mode="titleInfo"/>

			<!-- Call name templates -->
			<xsl:apply-templates
				select="datafield[@tag='100'] | datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'100')]"
				mode="name"/>
			<xsl:apply-templates
				select="datafield[@tag='110'] | datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'110')]"
				mode="name"/>
			<xsl:apply-templates
				select="datafield[@tag='111'] | datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'111')]"
				mode="name"/>
			<xsl:apply-templates
			...
			<xsl:apply-templates
				...
				mode="name"/>
			<xsl:apply-templates
				select="datafield[@tag='720'] | datafield[@tag='880'][starts-with(marc:subfield[@code='6'],'720')]"
				mode="name"/>
