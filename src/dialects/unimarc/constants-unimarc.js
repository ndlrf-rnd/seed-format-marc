...
const MARC_DIALECT_UNIMARC = 'UNIMARC';
...
поле 2-- содержит точку доступа, которая может использоваться для создания
...
поле 2-- содержит пояснительную точку доступа, которая не может использоваться для создания точек
  доступа в библиографической записи, и не приводится в поле 4-- авторитетной / нормативной записи
...
const UNIMARC_JSON_SCHEMA_PATH = path.join(__dirname, 'unimarc-bibliographic-rsl-1.0.0.schema.json');
